# Clean-session handoff: {{TITLE_MD}}

Continue this goal from a new, clean GPT or Codex session opened at the repository root.
...
Before acting, read `goal.md` and `progress.md` in full and inspect the current repository state. Do not trust this handoff prompt, prior chat, or the generated dashboard over the canonical Markdown and direct evidence.

## Resume protocol

1. Reconcile goal status, execution health, custody, verification, open gates, and the recovery capsule as separate state layers.
